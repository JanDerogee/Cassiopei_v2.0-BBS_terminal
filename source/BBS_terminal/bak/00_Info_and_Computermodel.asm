...
;COMMODOREPET20XX_BASIC1 = 1     ;the original basic version on the first PET ever build
;COMMODOREPET20XX = 1           ;40 col PET with basic 2 or 4
;;;;;;;;;;COMMODOREPET30XX = 1           ;40 col PET with basic 2 or 4
;COMMODOREPET40XX = 1           ;40 col PET with basic 2 or 4
;COMMODOREPET80XX = 1           ;80 col PET with basic 2 or 4
;COMMODOREVIC20 = 1
COMMODORE64     = 1
;COMMODORE128 = 1
;COMMODORE16PLUS4 = 1
...
VERSION_STRING_04 = 1 ;tens of day
VERSION_STRING_05 = 9 ;ones of day
